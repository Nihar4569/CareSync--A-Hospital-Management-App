...
import alogo from './Images/alogo.gif'
...
export default function () {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      setLoading(true)
      const { data } = await axios.get(`${server}/hosp/find/email/${hemail}`, { withCredentials: true });
      if (data.hpassword == password) {
        setAdata(data);
            ...
            <form class="space-y-4">
              ...
              <div>
                ...
                <div class="relative flex items-center">
                  <input value={hemail} onChange={(e)=>setHemail(e.target.value)} type="email" required class="w-full text-sm text-gray-800 border border-gray-300 px-4 py-3 rounded-lg outline-purple-600" placeholder="Enter Your Email" />
              ...
              <div class="flex flex-wrap items-center justify-between gap-4">
                ...
                <div class="text-sm">
                  <a href="jajvascript:void(0);" class="text-purple-600 hover:underline font-semibold">
              ...
              <div class="!mt-8">
                <button onClick={submitHandler} type="button" class="w-full shadow-xl py-3 px-4 text-sm tracking-wide rounded-lg text-white bg-purple-600 hover:bg-purple-700 focus:outline-none">
                  Log in
                </button>
              </div>

              <p onClick={register} class="text-sm !mt-8 text-center text-gray-800">Don't have an account <a href="javascript:void(0);" class="text-purple-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
            </form>
          </div>
